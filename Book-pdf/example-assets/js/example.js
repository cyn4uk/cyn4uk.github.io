...
(function ($) {
  ...
  var menuList = {
    "DOCUMENTATION": {
      ...
      "Basic HTML Template": "documentation.html#basic-html-template",
    ...
    "EXAMPLES extended": {
      ...
      "Controls Customization": "example-custom-controls-position.html",
      "Custom Location of Files": "example-custom-locations-of-files.html"

    },
    "DEMOS ( advanced )": {
      //"Intro : Read this": "demos intro.html",
      "Lightbox (Similar to Live Demo)": "demo_advanced-lightbox.html",
      "Full Height (max Window height)": "demo-fullheight.html",
      "Auto Height (Autofit to width)": "demo-autoheight.html",
      "Open PDF File": "demo-open-file.html",
      "Open PDF-base64 File": "demo-open-file-base64.html",
      "Require.js Usage": "example-requirejs-usage.html",
  ...
  var debugInfo = $('<div class="debug-info">').appendTo(menuDiv);
