...
function getSinPath(options) {
    ...
    var _addWidth = _options.addWidth || 1500;
    var _controlSep = _options.controlSep || 100;
    var _curves = _options.curves || 5;

    var x = - _addWidth;
    var y = _height / 2;
    var amplitudeX = (_width + _addWidth * 2) / _curves;     // X distance among curve points
    var amplitudeY = _height / 10;                            // Y distance between points and control points
